...
function filter(filterArr){
	...
	selectedCT = [];
	$.when(
		$.getJSON("data/json/Age.json",function (data){
			JsonArray[0] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/EducationAttainment.json",function (data){
			JsonArray[1] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/HousingAffordability.json",function (data){
			JsonArray[2] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/HousingCharacteristics.json",function (data){
			JsonArray[3] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/HousingVacancy.json",function (data){
			JsonArray[4] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/Income.json",function (data){
			JsonArray[5] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/JobCharacteristics.json",function (data){
			JsonArray[6] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/Population.json",function (data){
			JsonArray[7] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/RaceEthnicity.json",function (data){
			JsonArray[8] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/Transportation.json",function (data){
			JsonArray[9] = JSON.parse(JSON.stringify(data));
		}),
		$.getJSON("data/json/Unemployment.json",function (data){
