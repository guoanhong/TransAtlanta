...
function drawComparisonView(selectedCTArr) {
    ...
    $.getJSON("data/json/Population.json", function(json_data) {
        result = [];
    ...
    $.getJSON("data/json/Age.json", function(json_data) {
	    result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/RaceEthnicity.json", function(json_data) {
    	result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/EducationAttainment.json", function(json_data) {
    	result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/Income.json", function(json_data) {
    ...
    $.getJSON("data/json/Transportation.json", function(json_data) {
	    result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/HousingVacancy.json", function(json_data) {
	    result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/Unemployment.json", function(json_data) {
	    result = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
				if(json_data[key].CTN == selectedCTN[index]) {
    ...
    $.getJSON("data/json/JobCharacteristics.json", function(json_data) {
	    result1 = [];
	    result2 = [];
		for(var key in json_data) {
			for (var index in selectedCTN){
